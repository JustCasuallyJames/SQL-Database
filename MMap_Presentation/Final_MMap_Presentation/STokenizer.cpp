...
void STokenizer::make_table(int table[][MAX_COLUMNS]) {
    ...
    //Spaces
    mark_cell(0, table, 32, 6);
    mark_cell(0, table, 10, 6);
    mark_cell(6, table, 32, 6);
    mark_cell(6, table, 10, 6);


    //marking success states
    mark_cell(0, table, 0, 0);
    mark_cell(1, table, 0, 1);
    mark_cell(2, table, 0, 1);
    mark_cell(3, table, 0, 0);
    mark_cell(4, table, 0, 1);
    mark_cell(5, table, 0, 1);
    mark_cell(6, table, 0, 1);
}
